...
public class HttpHelperWithCookie {
	private CloseableHttpClient httpClient;

	private CookieStore cookieStore;

	public HttpHelperWithCookie() {
	 ...
	 * @return
	 */
	private List<NameValuePair> getParam(Map<String, Object> parameterMap) {
	 ...
	 * @param headerMap
	 */
	private void addHeaders(HttpEntityEnclosingRequestBase httpRequest,
